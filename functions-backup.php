 ...
 * Post view tracking
 */
function samacharpatra_track_single_post_views() {
    if (is_single() && function_exists('samacharpatra_track_post_views')) {
        samacharpatra_track_post_views(get_the_ID());
    }
}
add_action('wp_head', 'samacharpatra_track_single_post_views');
